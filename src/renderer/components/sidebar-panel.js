...
export class SidebarPanel extends LitElement {
    ...
    _handleDeleteUrl() {
        this.dispatchEvent(new CustomEvent('delete-url-requested', {
            bubbles: true,
            composed: true,
        }));
    }
                            ...
                            <div class="flex items-start justify-between">
                                ...
                                <button
                                    class="p-1 text-text-muted hover:text-red-400 transition-colors cursor-pointer
                                           rounded hover:bg-surface-3 flex-shrink-0"
                                    title="Delete all snapshots for this URL"
                                    @click=${this._handleDeleteUrl}
                                >
